...
//    }
    ...
    @Override
    public List<AssetsEntity> assetByLocation(String location) {
        System.out.println("tested");
        return assetRepo.findByLocation(location);

    }
    @Override
    public List<AssetsEntity>assetByStatus(String status){
        return assetRepo.findassets(status);
    }

    @Override
    public List<AssetsEntity>assetBydata(String location,String purchasedate,String status){
        return assetRepo.findassets(location,purchasedate,status);
    }
