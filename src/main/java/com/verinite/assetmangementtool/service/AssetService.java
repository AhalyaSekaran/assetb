...
public interface AssetService {
	...
	List<AssetsEntity> assetByLocation(String location);

	List<AssetsEntity>assetByStatus(String status);
	//	AssetsEntity assetByPurcheseDate(String purcheseDate);
	List<AssetsEntity>assetBydata(String location, String purchasedate, String status);
//	AssetsEntity assetByPurcheseDate(String purcheseDate);
